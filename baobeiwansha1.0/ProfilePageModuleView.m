...
-(void)layoutSubviews{
    ...
    TopBorder.frame = CGRectMake(0.0f, 0.0f, self.aframe.size.width, 0.5f);
    TopBorder.backgroundColor = [UIColor colorWithWhite:0.8f
                                                           alpha:1.0f].CGColor;
    [self.layer addSublayer:TopBorder];
    
    CALayer *BottomBorder = [CALayer layer];
    BottomBorder.frame = CGRectMake(0.0f, self.aframe.size.height, self.aframe.size.width, 0.5f);
    ...
    self.moduleTitleLabel.text = self.moduleTitle;
    ...
    self.moduleDetailLabel.text = self.moduleDetail;
    ...
    CALayer *tableViewTopBorder = [CALayer layer];
    tableViewTopBorder.frame = CGRectMake(0.0f, 0.0f, self.aframe.size.width, 0.5f);
    tableViewTopBorder.backgroundColor = [UIColor colorWithWhite:0.8f
                                                  alpha:1.0f].CGColor;
    [self.contentTableView.layer addSublayer:tableViewTopBorder];
}
